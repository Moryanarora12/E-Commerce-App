...
import in.shop.myShop.databinding.ItemCartBinding;
import in.shop.myShop.databinding.QuantityDialogBinding;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.ViewHolder> {
    ...
    public CartAdapter(Context context, ArrayList<Product> arrProduct,CartListener cartListener){
